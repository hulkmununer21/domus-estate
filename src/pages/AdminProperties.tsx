                ...
                <CardContent>
                  <div className="w-full overflow-x-auto">
                    <table className="min-w-[900px] w-full text-sm">
                      <thead>
                        <tr className="border-b border-border">
                          <th className="py-2 px-2 min-w-[120px] text-left">Unit</th>
                          <th className="py-2 px-2 min-w-[120px] text-left">Property</th>
                          <th className="py-2 px-2 min-w-[80px] text-left">Status</th>
                          <th className="py-2 px-2 min-w-[120px] text-left">Start Date</th>
                          <th className="py-2 px-2 min-w-[120px] text-left">End Date</th>
                          <th className="py-2 px-2 min-w-[100px] text-left">Rent</th>
                          <th className="py-2 px-2 min-w-[100px] text-left">Deposit</th>
                          <th className="py-2 px-2 min-w-[80px] text-left">Payment Day</th>
                          <th className="py-2 px-2 min-w-[120px] text-left">Signed At</th>
                          <th className="py-2 px-2 min-w-[80px] text-left">Actions</th>
                        </tr>
                      </thead>
                      <tbody>
